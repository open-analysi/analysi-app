...
```cy
# UTC (default)
timestamp = now()                 # "2026-04-26T14:30:00Z"

# Specific timezone
pst_time = now("US/Pacific")      # "2026-04-26T06:30:00-08:00"
london_time = now("Europe/London") # "2026-04-26T14:30:00+00:00"
...
| **Time** |
| `now(timezone?)` | string? | string | `now()` → "2026-04-26T14:30:00Z" |
| **Iteration** |
