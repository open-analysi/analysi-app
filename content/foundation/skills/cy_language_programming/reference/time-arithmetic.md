...
# "2026-04-26T14:30:00Z" → "2026-04-26T15:30:00Z"
...
# Timezone preserved
pst_time = "2026-04-26T14:00:00-08:00"
pst_later = add_duration(pst_time, "2h")
# Result: "2026-04-26T16:00:00-08:00"
```
...
is_same = timestamp_compare(
    "2026-04-26T14:00:00Z",
    "==",
    "2026-04-26T06:00:00-08:00"  # Same absolute time
)
...
range_start = "2026-04-26T00:00:00Z"
...
# Result: "2026-04-26T07:30:32-07:00"

# Fractional seconds
timestamp = from_epoch(1686839432.5)
# Result: "2026-04-26T14:30:32.500000Z"
...
```cy
# Basic conversion
epoch = to_epoch("2026-04-26T14:30:32Z")
# Result: 1686839432.0
...
epoch_utc = to_epoch("2026-04-26T14:30:32Z")
epoch_pst = to_epoch("2026-04-26T07:30:32-07:00")
...
```cy
# UTC timestamp
utc_time = "2026-04-26T14:00:00Z"
utc_later = add_duration(utc_time, "1h")
# Result: "2026-04-26T15:00:00Z"

# PST timestamp
pst_time = "2026-04-26T06:00:00-08:00"
pst_later = add_duration(pst_time, "1h")
# Result: "2026-04-26T07:00:00-08:00"

# Comparison works across timezones
is_same = timestamp_compare(
    "2026-04-26T14:00:00Z",           # 2pm UTC
    "==",
    "2026-04-26T06:00:00-08:00"       # 6am PST (same absolute time)
)
# Result: true
```
...
| Epoch to ISO 8601 | `from_epoch()` | `from_epoch(1686839432)` → `"2026-04-26T14:30:32Z"` |
| ISO 8601 to epoch | `to_epoch()` | `to_epoch("2026-04-26T14:30:32Z")` → `1686839432.0` |
