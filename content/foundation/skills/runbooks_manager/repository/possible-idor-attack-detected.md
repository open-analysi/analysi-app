  ...
  - |
    {
      ...
      "finding_info": {
        ...
        "analytic": {
          "name": "Possible IDOR Attack Detected",
          "type_id": 1,
          "type": "Rule"
        }
      },
      ...
      "observables": [
        ...
        },
        {
          ...
          "type_id": 6,
          "type": "URL String",
          "value": "https://10.10.20.15/get_user_info/"
        },
        {
          "name": "user_agent",
          "type_id": 16,
      ...
      "evidences": [
        {
          "src_endpoint": {"ip": "91.234.56.118"},
          "dst_endpoint": {"ip": "10.10.20.15"},
          "url": {"url_string": "https://10.10.20.15/get_user_info/"},
          "http_request": {
            "http_method": "POST",
      ...
      "raw_data": "Rule : Possible IDOR Attack Detected\nSeverity : High\nType : Web Attack\nEvent Time : Feb. 28, 2022, 10:48 p.m.\nHostname : WebServer1005\nDestination IP Address : 10.10.20.15\nSource IP Address : 91.234.56.118\nHTTP Request Method : POST\nRequested URL : https://10.10.20.15/get_user_info/\nUser-Agent : Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; .NET CLR 1.1.4322)\nAlert Trigger Reason : consecutive requests to the same page\nDevice Action: Allowed",
      "unmapped": {
