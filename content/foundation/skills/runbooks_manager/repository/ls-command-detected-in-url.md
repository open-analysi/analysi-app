  ...
  - |
    {
      ...
      "finding_info": {
        ...
        "analytic": {
          "name": "LS Command Detected in Requested URL",
          "type_id": 1,
          "type": "Rule"
        },
      ...
      "observables": [
        ...
        },
        {
          ...
          "type_id": 6,
          "type": "URL String",
          "value": "https://corpsite.example/blog/?s=skills"
        },
        {
          "name": "request_url",
          "type_id": 1,
          "type": "Hostname",
          "value": "corpsite.example"
        },
        {
          "name": "user_agent",
          "type_id": 16,
      ...
      "raw_data": "Rule : LS Command Detected in Requested URL\nSeverity : High\nType : Web Attack\nEvent Time : Feb, 27, 2022, 12:36 AM\nHostname : EliotPRD\nDestination IP Address : 203.198.7.15\nSource IP Address : 10.10.20.46\nHTTP Request Method : GET\nRequested URL : https://corpsite.example/blog/?s=skills\nUser-Agent : Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:24.0) Gecko/20100101 Firefox/24.0\nAlert Trigger Reason : URL Contains LS\nDevice Action : Allowed",
      "evidences": [
        {
          "src_endpoint": {"ip": "10.10.20.46"},
          "dst_endpoint": {"ip": "203.198.7.15"},
          "url": {"url_string": "https://corpsite.example/blog/?s=skills"},
          "http_request": {
            "http_method": "GET",
