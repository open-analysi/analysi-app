...
**Source Data:** `../ground-truth/web-attacks/soc165/` (structured ground truth format)
...
**Key Entities:**
- Attacker IP: 167.99.169.17 (Netherlands/DigitalOcean)
- Target: WebServer1001 (172.16.17.18)
...
- **Alert**: `../ground-truth/web-attacks/soc165/ld-alert/ld-alert.txt`
- **Analyst Reports**: `../ground-truth/web-attacks/soc165/analysts-reports/analyst-{1,2}.txt`
- **Tools Used**: `../ground-truth/web-attacks/soc165/tools/tools.txt`
- **Disposition**: `../ground-truth/web-attacks/soc165/disposition/disposition.txt`
...
### Field Mapping from ld-alert.txt
...
| Event Time | `time` | "2022-02-25T11:34:00Z" | ISO 8601 format |
| Severity | `severity` | "high" | Lowercase enum |
| Type | `finding_info.types[0]` | "Web Attack" | Detection type |
| Source IP Address | `observables[0].value` | "167.99.169.17" | Primary observable |
...
```json
{
  "alert": {
    ...
    "url_analysis": {
      "request_url": "https://172.16.17.18/search/?q=%22%20OR%201%20%3D%201%20--%20-",
      "http_method": "GET"
    }
  }
}
...
**Using `../ground-truth/web-attacks/soc165/` Format:**
...
✅ **This Example Used:**
- `ld-alert/ld-alert.txt` for alert data (Step 0)
...
```json
{
  "title": "Possible SQL Injection Payload Detected",
  "severity": "high",
  "observables": [{"value": "167.99.169.17", "type": "IP Address"}],
  "evidences": [{
    "src_endpoint": {"ip": "167.99.169.17"},
    "dst_endpoint": {"ip": "172.16.17.18"},
    "url": {"url_string": "https://172.16.17.18/search/?q=%22%20OR%201%20%3D%201%20--%20-"},
