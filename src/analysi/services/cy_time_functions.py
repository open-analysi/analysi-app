...
def _parse_iso8601(timestamp: str) -> datetime:
    ...
    Handles various ISO 8601 formats including:
        ...
        - "2025-10-31T14:30:00.123+00:00" (with milliseconds)
...
class CyTimeFunctions:
    ...
    def format_timestamp(self, timestamp: str, target_format: str) -> str:
        ...
        Args:
            timestamp: ISO 8601 timestamp string (e.g., "2025-12-11T03:30:42Z")
            target_format: Target format name. Supported formats:
                - "splunk": MM/DD/YYYY:HH:MM:SS (e.g., "12/11/2025:03:30:42")
                - "iso": ISO 8601 (normalized, e.g., "2025-12-11T03:30:42Z")
                - "date": YYYY-MM-DD (e.g., "2025-12-11")
                - "datetime": YYYY-MM-DD HH:MM:SS (e.g., "2025-12-11 03:30:42")
                - "clf": Common Log Format DD/Mon/YYYY:HH:MM:SS (e.g., "11/Dec/2025:03:30:42")
        ...
        Examples:
            format_timestamp("2025-12-11T03:30:42Z", "splunk") -> "12/11/2025:03:30:42"
            format_timestamp("2025-12-11T03:30:42.222+00:00", "splunk") -> "12/11/2025:03:30:42"
            format_timestamp("2025-12-11T03:30:42Z", "date") -> "2025-12-11"
            format_timestamp("2025-12-11T03:30:42Z", "datetime") -> "2025-12-11 03:30:42"
            format_timestamp("2025-12-11T03:30:42Z", "clf") -> "11/Dec/2025:03:30:42"
