...
class Alert(Base):
    ...
    Columns follow OCSF Detection Finding v1.8.0. Legacy columns (removed in V115):
    ...
    iocs, content_hash) have been removed in migration V113.
    """
    ...
    # Raw data preservation (renamed from raw_alert in V113)
    ...
    # NOTE: After migration V025, the table is partitioned by ingested_at, not triggering_event_time
    ...
    __table_args__ = (
        ...
        # ── OCSF indexes (match V113 migration) ──────────────────────
        Index(
