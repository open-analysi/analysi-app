...
- `primary_risk_entity_value`: TEXT - Main at-risk entity value (user@company.com, 192.168.1.50)
  ...
  "alerts": [
    {
      ...
      "triggering_event_time": "2025-01-01T10:00:00Z",
      "severity": "high",
...
```json
{
  ...
  "status": "running",
  "steps_detail": {
    "pre_triage": {"completed": true, "completed_at": "2025-01-01T10:01:00Z"},
    "context_retrieval": {"completed": true, "completed_at": "2025-01-01T10:02:00Z"},
    "workflow_builder": {"completed": true, "completed_at": "2025-01-01T10:03:00Z"},
    "workflow_execution": {"completed": false, "started_at": "2025-01-01T10:04:00Z"},
  ...
  "analyses": [
    {
      ...
      "completed_at": "2025-01-01T09:10:00Z",
...
```json
{
  ...
  "severity": "high",
  "triggering\_event\_time": "2024-12-31T12:48:21Z",
