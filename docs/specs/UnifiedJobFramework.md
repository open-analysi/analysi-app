...
- **R9**: The `job_tracking` JSONB stores framework metadata managed by the decorator. Schema:
  ```json
  {
    "attempt": 1,
    "max_attempts": 3,
    "errors": [{"attempt": 1, "error": "...", "error_type": "TimeoutError", "at": "2026-03-12T..."}],
...
```json
{
  ...
  "max_attempts": 3,
  "errors": [
    {"attempt": 1, "error": "TimeoutError: exceeded 900s", "error_type": "TimeoutError", "at": "2026-03-12T10:05:00Z"}
  ],
  "worker_id": "alert-worker-pod-7f8b9",
  "claimed_at": "2026-03-12T10:00:00Z",
  "duration_ms": 14523,
...
| Flyway migration (Phase 1) | `migrations/flyway/sql/V0XX__add_job_tracking_column.sql` (new) |
