...
{ "params": { "earliest": "2025-09-15T10:00:00Z", "latest": "2025-09-15T10:02:00Z" }}
```
...
{ "selector": { "integration_type": "splunk" }, "params": { "earliest": "2025-09-15T10:00:00Z", "latest": "2025-09-15T10:02:00Z" }, "safety": { "confirm_all": true }}
```
...
```json
{
  ...
  "params": {
    "earliest": "2025-09-15T10:00:00Z",
    "latest": "2025-09-15T10:02:00Z",
    "dedupe": true
  }
}
```
...
* Prefer explicit timestamps: `{ "earliest": "2025-09-15T10:00:00Z", "latest": "2025-09-15T10:02:00Z" }`
...
→ 201 { "schedule_id": "uuid", "next_run_at": "2025-09-15T10:03:00Z" }
```
