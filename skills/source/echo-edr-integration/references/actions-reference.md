...
- **Optional params**: `start_time`, `end_time` (ISO 8601 strings, e.g. `"2026-04-26T10:00:00Z"`)
...
```json
{
  "records": [
    {
      "visit_time": "2026-04-26T10:25:00Z",
...
```json
{
  ...
  "agent_version": "1.2.3",
  "last_seen": "2026-04-26T21:51:23+00:00",
  "risk_level": "low",
  "timestamp": "2026-04-26T21:51:23+00:00"
}
```
...
```json
{
  ...
  "hostname": "WORKSTATION-01",
  "timestamp": "2026-04-26T21:51:52+00:00"
}
```
...
```json
{
  ...
  "timestamp": "2026-04-26T21:51:45+00:00"
}
```
