...
```json
{
  ...
  "observables": [{"type": "Domain Name", "value": "attacker.example"}],
  "raw_data": {
    "vendor_field_1": "...",
    "vendor_field_2": "..."
  }
  ...
  "data_samples": [
    {
      ...
      "triggering_event_time": "2026-04-26T10:15:00Z"
    }
  ]
}
```
...
- `attacker.example`, `malicious.org` (reserved for examples)
- `phishing-site.tk`
...
```json
{
  "data_samples": [
    ...
    },
    {
      ...
      "triggering_event_time": "2026-04-26T11:30:00Z",
      "enrichments": {}
    }
  ]
}
...
```json
{
  "data_samples": [
    {
      "observables": [{"value": "attacker.example", "type": "Domain Name"}],
      "evidences": [{
