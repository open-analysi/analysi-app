...
<!-- EVIDENCE: MCP live test returned exit_node_count: 3093 on 2026-04-17. Tor Metrics (metrics.torproject.org) reports the count fluctuates between ~3,000 and ~4,500 depending on relay churn. -->
