  ...
  - |
    {
      ...
      "observables": [
        ...
        },
        {
          ...
          "type_id": 6,
          "type": "URL String",
          "value": "https://172.16.17.13/?file=../../../../etc/passwd"
        },
        {
          "name": "user_agent",
          "type_id": 16,
      ...
      "evidences": [
        {
          "src_endpoint": {"ip": "106.55.45.162"},
          "dst_endpoint": {"ip": "172.16.17.13"},
          "url": {"url_string": "https://172.16.17.13/?file=../../../../etc/passwd"},
          "http_request": {
            "http_method": "GET",
