...
Partition lifecycle is managed by pg_partman (configured by the baseline migration).
...
class PartitionLifecycleManager:
    ...
    pg_partman (configured by the baseline migration) handles partition creation and
