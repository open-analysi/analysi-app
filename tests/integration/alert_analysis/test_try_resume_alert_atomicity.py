...
# changed the DB constraint: 'paused_workflow_building' -> 'paused'.
...
class _PatchedAnalysisStatus(StrEnum):
    RUNNING = "running"
    PAUSED_WORKFLOW_BUILDING = "paused"  # DB value
...
class TestTryResumeAlertAtomicity:
    ...
    NOTE: changed the DB constraint from 'paused_workflow_building' to
