"""Integration tests for migration V038."""
...
class TestMigrationV038:
    """Test database migration V038 for KU type addition."""
    ...
    async def test_unique_constraint_created(
        ...
        V038 originally created (tenant_id, name, ku_type).
        V073 replaced it with (tenant_id, namespace, name, ku_type).
        """
        result = await integration_test_session.execute(
            text("""
    ...
    async def test_index_created(self, integration_test_session: AsyncSession):
        ...
        V038 originally created idx_component_tenant_ku_type_name.
        V073 replaced it with idx_component_tenant_ns_ku_type_name.
        """
        result = await integration_test_session.execute(
            text("""
