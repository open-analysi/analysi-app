...
class TestTaskTools:
    ...
    async def test_create_task_data_samples_full_structure(
        ...
        data_samples = [
            {
                ...
                "input": {"ip": "45.142.212.61", "context": "suspicious_login_attempt"},
            },
            {
                "name": "Known Malicious IP",
                "description": "Test with Tor exit node / known malicious IP",
                "input": {"ip": "185.220.101.1", "context": "firewall_alert"},
            },
        ]
        ...
        assert created_task.data_samples[0]["input"]["ip"] == "45.142.212.61"
