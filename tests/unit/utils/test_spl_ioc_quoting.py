...
class TestSPLIOCQuoting:
    ...
    def test_ioc_values_are_quoted(self):
        ...
        test_cases = [
            ...
            # URLs
            ("http://evil.com/malware", [], '"http://evil.com/malware"'),
    ...
    def test_complex_urls_are_properly_quoted(self):
        ...
        urls = [
            "https://evil.com/path?param1=value1&param2=value2",
    ...
    def test_ioc_filter_with_multiple_iocs(self):
        ...
        primary_entity = "user@company.com"
        iocs = [
            "192.168.1.100",
            "evil.domain.com",
        ...
        assert " OR " in result
        assert result.startswith('("user@company.com") AND (')
