...
class TestAlertEnums:
    ...
    def test_analysis_status_values(self):
        ...
        assert AnalysisStatus.PAUSED_WORKFLOW_BUILDING == "paused"  # V112: simplified
...
class TestAlertSchemas:
    ...
    def test_ocsf_observable_typed(self):
        ...
        alert = AlertBase(
            ...
            observables=[
                ...
                {"type_id": 6, "value": "https://evil.com", "type": "URL String"},
                {
                    "type_id": 8,
                    "value": "abc123",
    ...
    def test_ocsf_full_normalizer_output(self):
        ...
        alert = AlertCreate(
            ...
            evidences=[
                {
                    "src_endpoint": {"ip": "167.99.169.17", "port": 48575},
                    "dst_endpoint": {"ip": "172.16.17.18", "port": 443},
                    "url": {
            ...
            device={"hostname": "WebServer1001", "ip": "172.16.17.18", "type_id": 6},
            severity_id=4,
            disposition_id=1,
        )
