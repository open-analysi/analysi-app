...
class TestWhoisHistoryAction:
    ...
    async def test_whois_history_success(self, whois_history_action):
        ...
        mock_response = {
            "record_count": 15,
            "history": [
                {"date": "2026-04-26", "registrant": "Old Owner"},
    ...
    async def test_whois_history_dict_to_list_conversion(self, whois_history_action):
        ...
        mock_response = {
            "record_count": 1,
            "history": {"date": "2026-04-26", "registrant": "Owner"},
        }
...
class TestHostingHistoryAction:
    ...
    async def test_hosting_history_success(self, hosting_history_action):
        ...
        mock_response = {
            "registrar_history": [{"registrar": "GoDaddy", "date": "2026-04-26"}],
            "ip_history": [{"ip": "192.168.1.1", "date": "2026-04-26"}],
            "nameserver_history": [
                {"nameserver": "ns1.example.com", "date": "2026-04-26"}
            ],
        }
